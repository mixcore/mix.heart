...
namespace Mix.Example.Application.ViewModel {
  public class ProductViewModel
      : ViewModelBase<MixDbContext, ProductEntity, Guid, ProductViewModel> {
    public ProductViewModel(SaveProductDto dto) : base(dto) { MappDto(dto); }
    ...
    protected override
        Task SaveEntityRelationshipAsync(ProductEntity parentEntity) {
