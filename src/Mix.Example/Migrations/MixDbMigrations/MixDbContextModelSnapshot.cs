...
#pragma warning disable 612, 618
      modelBuilder.HasAnnotation("ProductVersion", "5.0.6");

      modelBuilder.Entity(
          "Mix.Example.Infrastructure.MixEntities.CategoryEntity", b => {
      ...
      modelBuilder.Entity(
          "Mix.Example.Infrastructure.MixEntities.ProductDetailEntity", b => {
            b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("TEXT");

            b.Property<string>("Description").HasColumnType("TEXT");

            b.Property<int>("InventoryNumber").HasColumnType("INTEGER");
      ...
      modelBuilder.Entity(
          "Mix.Example.Infrastructure.MixEntities.ProductEntity", b => {
            b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("TEXT");
            ...
            b.Property<string>("Producer").HasColumnType("TEXT");
      ...
      modelBuilder.Entity(
          "Mix.Example.Infrastructure.MixEntities.StoreEntity", b => {
            b.Property<Guid>("Id").ValueGeneratedOnAdd().HasColumnType("TEXT");
