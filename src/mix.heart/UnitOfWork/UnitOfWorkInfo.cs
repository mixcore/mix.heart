...
(DbContext dbContext) : IUnitOfWorkInfo {
  ...
  public void Begin() {
    if (ActiveTransaction == null) {
      SetTransaction(ActiveDbContext.Database.CurrentTransaction ??
                     ActiveDbContext.Database.BeginTransaction());
    }
  }

  public void Close() { ActiveTransaction?.Dispose(); }
