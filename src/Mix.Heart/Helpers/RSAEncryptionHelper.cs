...
namespace Mix.Cms.Lib.Helpers {
  public class RSAEncryptionHelper {
    ...
    public static Dictionary<string, string> GenerateKeys() {
      ...
      return new Dictionary<string, string>(){["PrivateKey"] = privKeyString,
    ...
    public static string GetEncryptedText(string plainTextData,
                                          string pubKeyString) {
      ...
      // we might want a string representation of our cypher text... base64 will
      // do
      return Convert.ToBase64String(bytesCypherText);
    }

    public static string GetDecryptedText(string cypherText,
