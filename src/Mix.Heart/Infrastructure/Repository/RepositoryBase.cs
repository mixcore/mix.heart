...
namespace Mix.Heart.Repository {
  public abstract class RepositoryBase<TDbContext> : IRepositoryBase<TDbContext>
    ...
    public virtual TDbContext Context => (TDbContext)(UnitOfWorkInfo
                                                      ?.ActiveDbContext);
      ...
      if (UnitOfWorkInfo != null) {
        ...
        if (UnitOfWorkInfo.ActiveTransaction == null) {
          ...
          UnitOfWorkInfo.SetTransaction(
              UnitOfWorkInfo.ActiveDbContext.Database
                  .CurrentTransaction
    ...
    protected virtual void CloseUow() { UnitOfWorkInfo.Close(); }
