...
namespace Mix.Heart.Infrastructure.EntityConfigurations.MySQL {
  public class MixCacheConfiguration : IEntityTypeConfiguration<MixCache> {
    public void Configure(EntityTypeBuilder<MixCache> entity) {
      ...
      entity.Property(e => e.Id).ValueGeneratedNever().HasColumnType(
          "varchar(150)");
      ...
      entity.Property(e => e.Value).IsRequired().HasColumnType(valueType);
    }
  }
}